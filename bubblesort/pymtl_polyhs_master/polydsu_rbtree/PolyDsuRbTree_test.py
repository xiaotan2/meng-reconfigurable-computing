...
from PolyDsuRbTree      import PolyDsuRbTree
...
insert_msgs = [
  ...
  xcel_req   ( 0x400,  0, MTX,   2,    96 ), xcel_resp   ( 0x400,   0, MTX,     0 ), # mem_pos
  xcel_req   ( 0x400,  0, MTX,   3,     4 ), xcel_resp   ( 0x400,   0, MTX,     0 ), # val
  xcel_req   ( 0x400,  0, MFX,   0,     0 ), xcel_resp   ( 0x400,   0, MFX,    96 ), # result = mem_pos
  ...
  xcel_req   ( 0x400,  0, MTX,   1,     0 ), xcel_resp   ( 0x400,   0, MTX,     0 ), # pos
  xcel_req   ( 0x400,  0, MTX,   2,    72 ), xcel_resp   ( 0x400,   0, MTX,     0 ), # mem_pos
  xcel_req   ( 0x400,  0, MTX,   3,     1 ), xcel_resp   ( 0x400,   0, MTX,     0 ), # val
  xcel_req   ( 0x400,  0, MFX,   0,     0 ), xcel_resp   ( 0x400,   0, MFX,    72 ), # result = mem_pos
...
def test( test_params, dump_vcd ):
  run_test( TestHarness( PolyDsuRbTree,
                         test_params.msgs[::2],
