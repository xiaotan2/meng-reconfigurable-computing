...
# model that tests the rbtree accelerator in isolation
...
class PolyDsuRbTree( Model ):
  ...
  def __init__( s ):
    ...
    # mem connections
    s.connect( s.rbtree_hls.memreq,  s.memreq        )
    s.connect( s.rbtree_hls.memresp, s.memresp_q.deq )
