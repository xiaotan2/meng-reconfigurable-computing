...
# model that tests the list accelerator in isolation
...
class PolyDsuList( Model ):
  ...
  def __init__( s ):
    ...
    # mem connections
    s.connect( s.list_hls.memreq,  s.memreq        )
    s.connect( s.list_hls.memresp, s.memresp_q.deq )
